...
\begin{figure}[htbp]
    \centering
    \includegraphics[scale=0.7]{ee466multisim/1.png}
    \caption{Seriekrets}
    \label{fig:sim2}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[scale=0.6]{ee466multisim/1-op.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[scale=0.75]{ee466multisim/2.png}
    \caption{Simuleringsresultat för seriekrets}
    \label{fig:sim-para}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[scale=0.75]{ee466multisim/3.png}
    \caption{Simuleringsresultat för seriekrets}
    \label{fig:sim3}
\end{figure}
...
% Jag får inte kompilera med rader 450-455 okommenterade. Osäker på vad det beror på.
%\begin{figure}
%\centering
%\includegraphics[width=0.7\linewidth]{ee466multisim/7-ACanalysis}
